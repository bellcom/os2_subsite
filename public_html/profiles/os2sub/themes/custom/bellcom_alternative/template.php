 ...
 */
function bellcom_alternative_preprocess_html(&$variables) {
 ...
 */
function bellcom_alternative_preprocess_page(&$variables) {
  $current_theme = variable_get('theme_default','none');
 ...
 */
function bellcom_alternative_preprocess_node(&$variables) {
 ...
 */
function bellcom_alternative_preprocess_comment(&$variables) {
 ...
 */
function bellcom_alternative_preprocess_taxonomy_term(&$variables) {
 ...
 */
function bellcom_alternative_preprocess_field(&$variables, $hook) {
}

/*
 * Implements hook_preprocess_region().
 */
function bellcom_alternative_preprocess_region(&$variables, $hook) {
}

/*
 * Implements theme_preprocess_block().
 */
function bellcom_alternative_preprocess_block(&$variables) {
 ...
 */
function bellcom_alternative_menu_tree__main_menu__main_navigation(&$variables) {
  return '<ul class="main-navigation-list">' . $variables['tree'] . '</ul>';
}
function bellcom_alternative_menu_tree__user_menu__main_navigation(&$variables) {
  return '<ul class="main-navigation-list main-navigation-right">' . $variables['tree'] . '</ul>';
}
function bellcom_alternative_menu_tree__main_menu__sidebar(&$variables) {
  return '<ul class="sidebar-navigation">' . $variables['tree'] . '</ul>';
}
function bellcom_alternative_menu_tree__user_menu__sidebar(&$variables) {
  return '<ul class="sidebar-navigation">' . $variables['tree'] . '</ul>';
}
 ...
 */
function bellcom_alternative_menu_link__main_navigation(array $variables) {
 ...
 * Implements theme_menu_link().
 */
function bellcom_alternative_menu_link__sidebar(array $variables) {
  $element = $variables['element'];
  $sub_menu = '';
