...
function site_color_process_html(&$variables) {
 if (module_exists('color')) {
 _color_html_alter($variables);
 }
}

function site_color_process_page(&$variables, $hook) {
 if (module_exists('color')) {
 ...
 */
function site_color_preprocess_html(&$variables) {
 ...
 */
function site_color_js_alter(&$javascript) {
 ...
 */
function site_color_css_alter(&$css) {
 ...
 */
function site_color_preprocess_page(&$variables) {
 ...
 */
function site_color_preprocess_node(&$variables) {
  $node = $variables['node'];
 ...
 */
function site_color_preprocess_comment(&$variables) {
 ...
 */
function site_color_node_view_alter(&$build) {
}
 ...
 */
function site_color_preprocess_node__full(&$variables) {
 ...
 * Implements hook_preprocess_node().
 */
function site_color_preprocess_node__os2web_spotbox_box(&$variables) {
 ...
 * Implements hook_preprocess_node().
 */
function site_color_preprocess_node__os2web_base_news(&$variables) {
 ...
 * Implements hook_preprocess_node().
 */
function site_color_preprocess_node__os2web_cp_service_cp_document(&$variables) {
 ...
 */
function site_color_preprocess_taxonomy_term(&$variables) {
  $term = $variables['term'];
 ...
 * Implements template_preprocess_taxonomy_term().
 */
function site_color_preprocess_taxonomy_term__teaser(&$variables) {
 ...
 */
function site_color_form_alter(&$form, &$form_state, $form_id) {
 ...
 */
function site_color_preprocess_field(&$variables, $hook) {
 ...
 */
function site_color_menu_tree(&$variables) {
 ...
 * Implements theme_menu_tree().
 */
function site_color_menu_tree__tabbed(&$variables) {
  return $variables['tree'];
}
 ...
 */
function site_color_menu_link__tabbed(array $variables) {
  $element = $variables['element'];
  $sub_menu = '';
 ...
 */
function site_color_preprocess_breadcrumb(&$variables) {
 ...
 * Implements theme_menu_link().
 */
function site_color_menu_link(array $variables) {
  $element = $variables['element'];
  $sub_menu = '';
